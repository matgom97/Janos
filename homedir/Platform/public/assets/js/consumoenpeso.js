...
//const url31 = `https://bmsjanos.duckdns.org/api/history/period/${startDate21}?end_time=${endDate12}&filter_entity_id=${entityId31}`;
//const url41 = `https://bmsjanos.duckdns.org/api/history/period/${startDate21}?end_time=${endDate12}&filter_entity_id=${entityId41}`;

const url12 = `https://janosbems.duckdns.org/api/history/period/${startDate21}?end_time=${endDate12}&filter_entity_id=${entityId12}`;
const url21 = `https://janosbems.duckdns.org/api/history/period/${startDate21}?end_time=${endDate12}&filter_entity_id=${entityId21}`;
const url31 = `https://janosbems.duckdns.org/api/history/period/${startDate21}?end_time=${endDate12}&filter_entity_id=${entityId31}`;
const url41 = `https://janosbems.duckdns.org/api/history/period/${startDate21}?end_time=${endDate12}&filter_entity_id=${entityId41}`;
