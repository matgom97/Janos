...
document.addEventListener("DOMContentLoaded", function () {
  const entities = ["sensor.home_energy_meter_gen5_electric_consumption_kwh"];
  ...
  /*   console.log("Datasets for Chart.js:", datasets); */
    datasets[0].backgroundColor = "#f68b1c";
    total2 = datasets[0].data.reduce((sum, data) => sum + data.y, 0);
    document.querySelector(".bar-unit-3").textContent =
      total2.toFixed(2) + " " +  "Kwh" ;
    new Chart(ctx1, {
      type: "bar",
      data: {
        datasets: [datasets[0]],
