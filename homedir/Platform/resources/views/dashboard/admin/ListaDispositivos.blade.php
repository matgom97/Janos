...
@section('admin-content')
    ...
    align-items: baseline;">
        Lista de dispositivos
        <a href="{{ route('admin.creardispositivos') }}" style="text-decoration: none">
            <button class="btn-create">Crear Nuevo dispositivo<i class='bx bx-plus'></i></button>
        </a>
        ...
        <tbody>
            @foreach ($dispositivos as $dispositivo)
                <tr>
                    ...
                    <td>
                        {{ $dispositivo->dispositivo_habitacion_id }}

                    </td>

                    <td>
                        @if ($dispositivo->dispositivo_estado == 1)
                    ...
                    <td>
                     ...
                     {{--    <div style="display: flex">
                            ...
                            <button class="openModal btn-info" data-modal-id="modal-{{ $hotel->hotel_id }}">
                                Info <i class='bx bx-info-circle'></i></button>

                            <div id="modal-{{ $dispositivo->dispositivo_id }}" class="modal">
                                <div class="modal-content">
                                    <span class="close">&times;</span>
                                    <p>Informacion del dispositivo</p>
                                    <hr>
                                    <li>
                                        Nombre: {{ $dispositivo->dispositivo_nombre }}

                                    </li>
                                    <li>
                                       Direccion: {{ $dispositivo->dispositivo_descripcion}}

                                    </li>

                                 
                                    <li>
                                        Telefono: {{ $dispositivo->dispositivo_estado }}

                                    </li>
                                    <li>
                                        Creado el:{{ $dispositivo->created_at->format('d/m/Y H:i:s') }}

                                    </li>
                                    <li>
                                        Ultima actualizacion:{{ $dispositivo->updated_at->format('d/m/Y H:i:s') }}
                                    </li>
                            ...
                            <form action="{{ route('dispositivos.destroy', $dispositivo->dispositivo_id) }}" method="POST">
                                @csrf
                                @method('DELETE') 
