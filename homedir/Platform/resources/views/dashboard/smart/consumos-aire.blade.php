...
@section('content')
    <ul class="list-space">
        ...
        <h1>Por aparato</h1>
        <a href="{{ route('Consumos') }}" class="list-item" style="text-decoration:none; color:black">
            <span class="slash-active">Aire acondicionado</span>
...
@section('smart-content')
    ...
    <h2 class="title-2">
        Consumo del aire acondicionado en la ultima semana de la habitacion 204
    </h2>
    <canvas id="ctx3" style="display:none"></canvas>
    <canvas id="ctx2" style="display:none"></canvas>
    <canvas id="ctx1" style="    margin: 10px 0px 40px 0px;" ></canvas>

    <div class="convencion">
        <span>
            Total consumo de aire acondicionado. ultima semana.
        </span>
        <div style="margin-left: 20px;">
            <div class="bar-unit" style="color:white; font-weight:600">
            </div>
        </div>
    </div>
@endsection
...
.section {
    ...
    * {
    ...
    .bar-unit {
        ...
        background: #F68B1C;
        border-radius: 2px;
        border: 1px solid rgb(255, 201, 164);
...
<script src="assets/js/consumos-aire.js"></script>
