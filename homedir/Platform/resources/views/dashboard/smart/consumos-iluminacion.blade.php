...
@section('content')
    <ul class="list-space">
        ...
        <a href="{{ route('Consumos') }}" class="list-item" style="text-decoration:none; color:black">
            <span class="slash-active">Iluminacion</span>
...
@section('smart-content')
    ...
    <h2 class="title-2">
        Consumo de la iluminacion en la ultima semana de la habitacion 204
    </h2>
    <canvas id="ctx3" style="display:none"></canvas>
    <canvas id="ctx2" style="display:none"></canvas>
    <canvas id="ctx11" style="    margin: 10px 0px 40px 0px;"></canvas>

    <div class="convencion">
        <span>
            Total consumo de la iluminacion en la ultima semana.
        </span>
        <div style="margin-left: 20px;">
            <div class="bar-unit" style="color:black; font-weight:600">
            </div>
        </div>
    </div>
@endsection
...
<script src="assets/js/consumos-iluminacion.js"></script>
