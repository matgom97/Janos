...
@section('content')
    <ul class="list-space">
        ...
        <a href="{{ route('Consumos') }}" class="list-item" style="text-decoration:none; color:black">
            <span class="slash-active">Televisor</span>
...
@section('smart-content')
    ...
    <h2 class="title-2">
        Consumo del televisor en la ultima semana de la habitacion 204
    </h2>
    ...
    <div class="convencion">
        <span>
            Total consumo del tv en la ultima semana.
        </span>
...
<script src="assets/js/consumos-tv.js"></script>
