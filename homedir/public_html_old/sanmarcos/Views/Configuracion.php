	...
	<div class="container d-flex">
			...
			<div class="d-flex flex-column flex-shrink-0 overflow-hidden aside br-rad-15" style="width: 306px;">
				...
				<div class="bg-white p-10" id="MenuAside">
					<ul class="nav nav-pills flex-column mb-auto color-bms mt-10" role="tablist">
						...
						<li class="nav-item" role="presentation">
							<a id="Menu_Configuracion" class="nav-item nav-link drop active" type="button" href="Configuracion.php">
								Configuración
							</a>
						</li>
						<li class="nav-item" role="presentation">
		...
		<div class="content">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
						<ul class="navbar-nav me-auto mb-2 mb-lg-0">
							...
							<li class="nav-item">
								<a id="Menu_Configuracion" class="nav-item nav-link drop active" type="button" href="Configuracion.php">Configuración</a>
							</li>
							<li class="nav-item">
			...
			<div class="content-principal tab-content" id="Principal">
				<div id="Configuracion" class="chilContents tab-pane fade show active" role="tabpanel" aria-labelledby="Menu_Panel_de_control" tabindex="0">
					...
					<div class="d-flex">
						...
						<div class="sectrhdhj fiu70">
							<div class="d-flex">
								<div>
									<h3 class="tittles-bms configstyle"><img class="xs" src="../Templates/Icons/usuario.svg">Usuario:</h3>
								</div>
								<div class="nobackg">
							...
							<div class="d-flex">
								<div>
									<h3 class="tittles-bms configstyle"><img class="xs" src="../Templates/Icons/cargo.svg">Cargo:</h3>
								</div>
								<div class="nobackg">
