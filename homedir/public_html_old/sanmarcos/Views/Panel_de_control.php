				...
				<div class="bg-white p-10" id="MenuAside">
					<ul class="nav nav-pills flex-column mb-auto color-bms mt-10" role="tablist">
						<li class="nav-item" role="presentation">
							<a id="Menu_Panel_de_control" type="button" class="nav-item nav-link drop active">
								Panel de Control
							</a>
						</li>
						<li class="nav-item" role="presentation">
		...
		<div class="content">
			...
			<nav class="navbar navbar-expand-lg fixme" style="background: #17112d;">
				<div class="container-fluid">
					...
					<a class="navbar-brand" href="Index."><img class="logo-aside" src="../Templates/Images/Resources/logo-JMS-JANOS.png"></a>
					<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
						<ul class="navbar-nav me-auto mb-2 mb-lg-0">
							...
							<li class="nav-item">
								<a id="Menu_Panel_de_controlz" type="button" class="nav-item nav-link drop active">Panel de Control</a>
							</li>
							<li class="nav-item">
			...
			<div class="content-principal tab-content" id="Principal">
				<div id="Panel_de_Control" class="chilContents tab-pane fade show active" role="tabpanel" aria-labelledby="Menu_Panel_de_control" tabindex="0">
					<h3 class="tittles-bms">Panel de Control</h3>
