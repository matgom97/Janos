			...
			<div class="d-flex flex-column flex-shrink-0 overflow-hidden aside br-rad-15" style="width: 306px;">
				...
				<div class="bg-white p-10" id="MenuAside">
					<ul class="nav nav-pills flex-column mb-auto color-bms mt-10" role="tablist">
						...
						<li class="nav-item" role="presentation">
							<a id="Menu_Usuario_E_Informacion" class="nav-item nav-link drop active" type="button" href="Usuario.php">
		...
		<div class="content">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
						<ul class="navbar-nav me-auto mb-2 mb-lg-0">
							...
							<li class="nav-item">
								<a id="Menu_Usuario_E_Informacion" class="nav-item nav-link drop active" type="button" href="Usuario.php">Usuario e información de la cuenta</a>
							</li>
							<li class="nav-item">
			...
			<div class="content-principal tab-content" id="Principal">
				<div id="Panel_de_Control" class="chilContents tab-pane fade show active" role="tabpanel" aria-labelledby="Menu_Panel_de_control" tabindex="0">
					<h3 class="tittles-bms">Usuario e información de la cuenta</h3>
					<div class="d-flex">
						<div class="flex-center fiu30">
							<div class="contentLogoImgHotel">
								<img src="../Templates/Images/Resources/descarga.jfif">
							</div>
						</div>
						
						<div class="sectrhdhj fiu70 jjjjjo">
							<div class="d-flex">
								<div>
									<h3 class="tittles-bms"><img class="xs" src="../Templates/Icons/hotel.svg">Nombre del Hotel:</h3>
								</div>
								<div class="nobackg">
									<h3 class="tittles-bms">Hotel San Marcos</h3>
								</div>
							</div>
							<div class="d-flex">
								<div>
									<h3 class="tittles-bms"><img class="xs" src="../Templates/Icons/direccion.svg">Dirección:</h3>
								</div>
								<div class="nobackg">
									<h3 class="tittles-bms">Calle 29K No 31B-103 Portales de la Avenida</h3>
								</div>
							</div>
							<div class="d-flex">
								<div>
									<h3 class="tittles-bms"><img class="xs" src="../Templates/Icons/telefono.svg">Teléfono:</h3>
								</div>
								<div class="nobackg">
									<h3 class="tittles-bms">(+57) 3207113422</h3>
								</div>
							</div>
							<div class="d-flex">
								<div>
									<h3 class="tittles-bms"><img class="xs" src="../Templates/Icons/mail.svg">Correo electrónico:</h3>
								</div>
								<div class="nobackg">
									<h3 class="tittles-bms">jefecalidad.camaco@gmail.com</h3>
								</div>
							</div>
							<div class="d-flex">
								<div>
									<h3 class="tittles-bms"><img class="xs" src="../Templates/Icons/usuario.svg">Nombre del contacto:</h3>
								</div>
								<div class="nobackg">
									<h3 class="tittles-bms">Gioni</h3>
								</div>
							</div>
							<div class="d-flex">
								<div>
									<h3 class="tittles-bms"><img class="xs" src="../Templates/Icons/contrato.svg">Número del contrato:</h3>
								</div>
								<div class="nobackg">
									<h3 class="tittles-bms">2023-001</h3>
								</div>
							</div>
							<div class="d-flex">
								<div>
									<h3 class="tittles-bms"><img class="xs" src="../Templates/Icons/soporte.svg">Correo electrónico para soporte técnico:</h3>
								</div>
								<div class="nobackg">
									<h3 class="tittles-bms">ogarcia@creativespacestudio.co</h3>
								</div>
							</div>
