...
const url11 = 'https://bmsjanos.duckdns.org/api/history/period/${startDate1}?end_time=${endDate1}&filter_entity_id=${entityId11}';
const url22 = 'https://bmsjanos.duckdns.org/api/history/period/${startDate1}?end_time=${endDate1}&filter_entity_id=${entityId22}';
