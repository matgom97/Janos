...
class __TwigTemplate_180cb701ace9bdd738cdd52205cfa5e4 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Series:");
        ...
        foreach ($context['_seq'] as $context["idx"] => $context["key"]) {
            // line 76
            echo "              ";
            if (twig_get_attribute($this->env, $this->source, (($__internal_compile_0 = ($context["fields_meta"] ?? null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0[$context["idx"]] ?? null) : null), "isNumeric", [], "any", false, false, false, 76)) {
                // line 77
                echo "                ";
        ...
        foreach ($context['_seq'] as $context["idx"] => $context["key"]) {
            // line 95
            if (twig_get_attribute($this->env, $this->source, (($__internal_compile_2 = ($context["fields_meta"] ?? null)) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess ? ($__internal_compile_2[$context["idx"]] ?? null) : null), "isNumeric", [], "any", false, false, false, 95)) {
                // line 96
                echo twig_escape_filter($this->env, ($context["idx"] . " "), "html", null, true);
            }
        }
...
echo _gettext("Value Column:");
        ...
        foreach ($context['_seq'] as $context["idx"] => $context["key"]) {
            // line 130
            echo "              ";
            if (twig_get_attribute($this->env, $this->source, (($__internal_compile_4 = ($context["fields_meta"] ?? null)) && is_array($__internal_compile_4) || $__internal_compile_4 instanceof ArrayAccess ? ($__internal_compile_4[$context["idx"]] ?? null) : null), "isNumeric", [], "any", false, false, false, 130)) {
                // line 131
                echo "                ";
